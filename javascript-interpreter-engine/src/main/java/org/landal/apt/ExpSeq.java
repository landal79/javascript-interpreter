...
/**
 * Questa classe rappresenta la categoria sintattica concatenazione di espressioni
 * mediante l'operatore ','.
 * @author  Landini Alex
 * @version 1.0
 */
 public class ExpSeq extends BinOpExp{
         ...
         */
 	public ExpSeq (Exp l, Exp r){ super(l,r);}
