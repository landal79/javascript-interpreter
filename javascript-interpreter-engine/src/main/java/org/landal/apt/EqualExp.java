...
/**
 * Questa classe rappresenta la categoria sintattica espressione di uguaglianza, '=='.
 * @author  Landini Alex
 * @version 1.0
 */
 public class EqualExp extends BinOpExp{
 	...
 	/**
         ...
         */
     public EqualExp (Exp l, Exp r){ super(l,r);}
