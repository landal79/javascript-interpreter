...
/**
 * Questa classe rappresenta la categoria sintattica blocco di istruzioni, 
 * racchiuso fra { , }.
 * @author  Landini Alex
 * @version 1.0
 */
 public class BloccoIstr extends Istr{
 	...
 	*/
 	...
 	/**
         ...
         * @param   l   lista delle istruzioni
         */
        public BloccoIstr(ListaIstr l){
		this.l=l;
        }
        
        /**
         * Fornisce la lista delle istruzioni.
         * @return  ListaIstr   riferimento alla lista delle istruzioni.
         */
        public ListaIstr getListaIstr(){return l;}
