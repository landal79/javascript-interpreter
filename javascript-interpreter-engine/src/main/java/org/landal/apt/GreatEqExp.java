...
/**
 * Questa classe rappresenta la categoria sintattica espressione relazionale '>='.
 * @author  Landini Alex
 * @version 1.0
 */
public class GreatEqExp extends BinOpExp{
 	...
 	/**
         ...
         */
        public GreatEqExp (Exp l, Exp r){ super(l,r);}
