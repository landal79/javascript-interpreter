...
public class LexerTest {
	...
	public void testLetterali() {
		...
		try {
			...
			resExpected = "123.66999";
			lex.init(new StringReader("123.66999"));
			res = lex.nextToken().toString();
			assertTrue("lexer numeri_2: ", resExpected.equals(res));
			...
			resExpected = new String("Hello world i'm here");
			lex.init(new StringReader("\"Hello world i'm here\""));
			res = lex.nextToken().toString();
